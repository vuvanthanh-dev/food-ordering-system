...
import com.thanhvv.food.ordering.system.order.service.domain.exception.OrderDomainException;
import com.thanhvv.food.ordering.system.order.service.domain.valueobject.OrderItemId;
...
public class Order extends AggregateRoot<OrderId> {
    ...
    private void validateItemPrice(OrderItem orderItem) {
        if (!orderItem.isPriceValid()) {
            throw new OrderDomainException("Order item price: " + price.getAmount() + " is not equal to Order item total: " + orderItem.getPrice().getAmount() + "!");
        }
    }
